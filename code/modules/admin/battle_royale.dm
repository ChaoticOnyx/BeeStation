...
#define LOOT_DIRECTORY "config/battleroyal"
/obj/item/storage/box/medsprays
GLOBAL_LIST_INIT(battle_royale_basic_loot, splittext(replacetext(file2text("[LOOT_DIRECTORY]/basic_loot.txt"),",\n",","),","))
GLOBAL_LIST_INIT(battle_royale_good_loot, splittext(replacetext(file2text("[LOOT_DIRECTORY]/good_loot.txt"),",\n",","),","))
GLOBAL_LIST_INIT(battle_royale_insane_loot, splittext(replacetext(file2text("[LOOT_DIRECTORY]/insane_loot.txt"),",\n",","),","))
