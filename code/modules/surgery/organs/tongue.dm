...
/obj/item/organ/tongue/lizard/handle_speech(datum/source, list/speech_args)
	...
	var/static/regex/lizard_hiSS = new("S+", "g")
	var/static/regex/lizard_hiss1 = new("с+", "g")
	var/static/regex/lizard_hiSS1 = new("С+", "g")
	var/static/regex/lizard_hiss2 = new("ш+", "g")
	var/static/regex/lizard_hiSS2 = new("Ш+", "g")
	var/static/regex/lizard_hiss3 = new("щ+", "g")
	var/static/regex/lizard_hiSS3 = new("Щ+", "g")
	var/message = speech_args[SPEECH_MESSAGE]
	if(message[1] != "*")
		message = lizard_hiss.Replace(message, "sss")
		message = lizard_hiSS.Replace(message, "SSS")
		message = lizard_hiss1.Replace(message, "ссс")
		message = lizard_hiSS1.Replace(message, "ССС")
		message = lizard_hiss2.Replace(message, "шшш")
		message = lizard_hiSS2.Replace(message, "ШШШ")
		message = lizard_hiss3.Replace(message, "щщщ")
		message = lizard_hiSS3.Replace(message, "ЩЩЩ")
